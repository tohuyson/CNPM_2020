...
{{--                        Thông báo trạng thái nếu thực hiên thêm xóa,sửa hoặc xóa--}}
                        @if(session('success'))
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody>
{{--                                        Thực hiện trả dữ liệu phim về từng dòng--}}
...
{{--                                                nếu show_home bằng 1 thì hiển thị ra ngoài trang chủ và ngược lại--}}
                                                <td>
                                                    @if ($row->show_home==1)
                                                ...
                                                <td>
{{--                                                    nếu isActive bằng 1 thì phim sẽ tồn tại--}}
                                                    @if ($row->isActive==1)
